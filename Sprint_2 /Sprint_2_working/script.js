        ...
        newName.innerHTML = `<div class="olUsrImg">
                            ...
                            <div class="oldUser-comment__info">
                                <div class="oldUser-comment__info-holder">
                                    <div class="user-comment__name">${input[i].name}</div>
                                    <div class="user-comment__date">${input[i].date}</div>
                                </div>
                                <p class="oldUser-comment__submission">${input[i].comment}</p>
                            </div> `;
...
function getData() {
    axios
        ...
        .then(response => {
            ...
            console.log(comment.map(item => createComments(item)))
        })
        .catch(error => {
            console.log(error);
    });
